...
### 2. Файл application/DB.py создает базу данных и наполняет ее первичными данными
### 3. В файле application/models.py содержатся модели (структура БД)
### 4. Файл application/config.py содержаться константы 
